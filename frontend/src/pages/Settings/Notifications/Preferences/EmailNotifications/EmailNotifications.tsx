        ...
        <>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    {"Get emails to find out what’s going on when you’re not on Tweetgram. You can turn them off anytime. "}
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant={"body1"} component={"span"}>
                        News about Tweetgram product and feature updates
                    </Typography>
                    <Checkbox checked />
                </div>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant={"body1"} component={"span"}>
                        Tips on getting more out of Tweetgram
                    </Typography>
                    <Checkbox checked />
                </div>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant={"body1"} component={"span"}>
                        Things you missed since you last logged into Tweetgram
                    </Typography>
                    <Checkbox checked />
                </div>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant={"body1"} component={"span"}>
                        News about Tweetgram on partner products and other third party services
                    </Typography>
                    <Checkbox checked />
                </div>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant={"body1"} component={"span"}>
                        Participation in Tweetgram research surveys
                    </Typography>
                    <Checkbox checked />
                </div>
            </div>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <div className={globalClasses.infoItemCheckbox}>
                    <Typography variant={"body1"} component={"span"}>
                        Tips on Tweetgram business products
                    </Typography>
                    <Checkbox checked />
                </div>
            </div>
