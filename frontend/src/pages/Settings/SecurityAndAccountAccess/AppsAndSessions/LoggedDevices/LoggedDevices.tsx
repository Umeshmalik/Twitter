        ...
        <>
            <div className={classnames(classes.infoItemWrapper, globalClasses.itemInfoWrapper)}>
                <Typography variant={"subtitle2"} component={"div"}>
                    These are browsers, devices, and information Tweetgram uses to personalize your experience.
                    This includes devices and browsers you haven’t used to log in to Tweetgram, as well as email
                    addresses and phone numbers like those linked to your Tweetgram account. <MuiLink
            ...
            <div className={classnames(classes.infoItemWrapper, globalClasses.itemInfoWrapper)}>
                ...
                <Typography variant={"subtitle2"} component={"div"}>
                    {`There are inferred hashes of email addresses that share common components with the email
                        address you have provided to Tweetgram. You can remove this information by disabling
