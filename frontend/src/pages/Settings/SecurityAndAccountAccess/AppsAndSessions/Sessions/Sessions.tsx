        ...
        <>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Sessions are the devices you are using or that have used your Tweetgram account. These are the
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    You’re logged into this Tweetgram account on this device and are currently using it.
                </Typography>
            </div>
            <Link
                to={{
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    {`Logging out will end 1 of your other active Tweetgram sessions. It won’t affect your current active session. `}
