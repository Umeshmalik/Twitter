        ...
        <div>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    You’re about to start the process of deactivating your Tweetgram account. Your display name,
                    @username, and public profile will no longer be viewable on Tweetgram.com, Tweetgram for iOS, or
                    Tweetgram for Android.
                </Typography>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"h5"} component={"div"}>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    You can restore your Tweetgram account if it was accidentally or wrongfully deactivated for up
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    {"To use your current @username or email address with a different Tweetgram account, "}
                    <MuiLink variant="subtitle2" to={SETTINGS_INFO} component={Link}>
                        change them
                    </MuiLink>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    If you want to download your Tweetgram data, you’ll need to complete both the request and
