        ...
        <>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Manage what information you see and share on Tweetgram.
                </Typography>
            </div>
            <Divider />
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"h5"} component={"div"}>
                    Your Tweetgram activity
                </Typography>
            </div>
            <div className={classnames(classes.listWrapper, globalClasses.listItemWrapper)}>
                <List component="nav" aria-label="main mailbox folders">
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_AUDIENCE}>
                        <ListItem>
                            ...
                            <div>
                                ...
                                <Typography variant={"subtitle2"} component={"div"}>
                                    Manage what information you allow other people on Tweetgram to see.
                                </Typography>
                            </div>
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_CONTENT_YOU_SEE}>
                        <ListItem>
                            ...
                            <div>
                                ...
                                <Typography variant={"subtitle2"} component={"div"}>
                                    Decide what you see on Tweetgram based on your preferences like Topics and
                                    interests
                                </Typography>
                            </div>
                            <div className={globalClasses.arrowIcon}>
                    ...
                    <div className={globalClasses.itemInfoWrapper}>
                        <Typography variant={"h5"} component={"div"}>
                            Data sharing and off-Tweetgram activity
                        </Typography>
                    </div>
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_ADS_PREFERENCES}>
                        <ListItem>
                            ...
                            <div>
                                ...
                                <Typography variant={"subtitle2"} component={"div"}>
                                    Manage your ads experience on Tweetgram.
                                </Typography>
                            </div>
                            <div className={globalClasses.arrowIcon}>
                                {ArrowRightIcon}
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_OFF_TWITTER_ACTIVITY}>
                        <ListItem>
                            ...
                            <div>
                                <Typography variant={"body1"} component={"div"}>
                                    Off-Tweetgram activity
                                </Typography>
                                <Typography variant={"subtitle2"} component={"div"}>
                                    Manage how Tweetgram uses your online activity outside of Tweetgram, such as the
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_DATA_SHARING_WITH_BUSINESS_PARTNERS}>
                        <ListItem>
                            ...
                            <div>
                                ...
                                <Typography variant={"subtitle2"} component={"div"}>
                                    Allow sharing of additional information with Tweetgram's business partners.
                                </Typography>
                            </div>
                            <div className={globalClasses.arrowIcon}>
                                {ArrowRightIcon}
                    ...
                    <Link to={SETTINGS_PRIVACY_AND_SAFETY_LOCATION_INFORMATION}>
                        <ListItem>
                            ...
                            <div>
                                ...
                                <Typography variant={"subtitle2"} component={"div"}>
                                    Manage the location information Tweetgram uses to personalize your experience.
                                </Typography>
                            </div>
                            <div className={globalClasses.arrowIcon}>
                                {ArrowRightIcon}
                    ...
                    <div className={globalClasses.itemInfoWrapper}>
                        <Typography variant={"h5"} component={"div"}>
                            Learn more about privacy on Tweetgram
                        </Typography>
                    </div>
