        ...
        <>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Manage how Tweetgram uses your online activity outside of Tweetgram, such as the websites you visit, to
            ...
            <div className={globalClasses.itemInfoWrapper}>
                ...
                <Typography variant={"subtitle2"} component={"div"}>
                    {`Tweetgram will always personalize your experience based on information you’ve provided, as well as the
                        devices you’ve used to log in. When this setting is enabled, Tweetgram may also personalize based on
...
export default withDocumentTitle(OffTwitterActivity)("Off-Tweetgram activity");
