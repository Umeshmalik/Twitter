        ...
        <>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Limit how Tweetgram uses some of your network data. These settings affect all the Tweetgram accounts on
                    this browser.
                </Typography>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
                ...
                <Typography variant={"subtitle2"} component={"div"}>
                    If selected, Tweetgram will use less network data.
                </Typography>
            </div>
