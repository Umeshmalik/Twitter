        ...
        <>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Manage aspects of your Tweetgram experience such as limiting color contrast and motion. These settings
                    affect all the Tweetgram accounts on this browser.
                </Typography>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
