        ...
        <>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Manage how Tweetgram content is displayed to you.
                </Typography>
            </div>
                    ...
                    <Link to={SETTINGS_ACCESSIBILITY_DISPLAY_AND_LANGUAGES_ACCESSIBILITY}>
                        <ListItem>
                            ...
                            <div>
                                ...
                                <Typography variant={"subtitle2"} component={"div"}>
                                    Manage aspects of your Tweetgram experience such as limiting color contrast and
                                    motion.
                                </Typography>
                            </div>
                        ...
                        <ListItem>
                            ...
                            <div>
                                ...
                                <Typography variant={"subtitle2"} component={"div"}>
                                    ...
                                    Tweetgram accounts on this browser.
                                </Typography>
                            </div>
                            <div className={globalClasses.arrowIcon}>
                                {ArrowRightIcon}
                    ...
                    <Link to={SETTINGS_ACCESSIBILITY_DISPLAY_AND_LANGUAGES_DATA}>
                        <ListItem>
                            ...
                            <div>
                                ...
                                <Typography variant={"subtitle2"} component={"div"}>
                                    Limit how Tweetgram uses some of your network data. These settings affect all the
                                    Tweetgram accounts on this browser.
                                </Typography>
                            </div>
                            <div className={globalClasses.arrowIcon}>
