        ...
        <>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Manage which languages are used to personalize your Tweetgram experience.
                </Typography>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Select your preferred language for headlines, buttons, and other text from Tweetgram.
                </Typography>
            </div>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Select additional languages for the content you want to see on Tweetgram.
                </Typography>
            </div>
            ...
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Manage the languages Tweetgram inferred based on your activity, such as the accounts you follow and
