        ...
        <>
            <div className={globalClasses.itemInfoWrapper}>
                <Typography variant={"subtitle2"} component={"div"}>
                    Manage your font size, color, and background. These settings affect all the Tweetgram accounts on this
                    browser.
                </Typography>
            </div>
            <div className={globalClasses.itemInfoWrapper}>
                <div className={classes.tweetInfoWrapper}>
                    ...
                    <div>
                        ...
                        <Typography variant={"body1"} component={"div"} className={classes.tweetText}>
                            At the heart of Tweetgram are short messages called Tweets — just like this one — which can
                            include photos, videos, links, text, hashtags, and mentions like <span
                            className={classes.tweetLink}>@Tweetgram</span>
                        </Typography>
                    </div>
                </div>
            </div>
